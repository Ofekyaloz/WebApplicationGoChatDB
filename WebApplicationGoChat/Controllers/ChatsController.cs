...
namespace WebApplicationGoChat.Controllers
{
    public class ChatsController : Controller
    {
        ...
        public ChatsController(WebApplicationGoChatContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstContact,SecondContact")] Chat chat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstContact,SecondContact")] Chat chat)
        {
            if (id != chat.Id)
            {
                return NotFound();
